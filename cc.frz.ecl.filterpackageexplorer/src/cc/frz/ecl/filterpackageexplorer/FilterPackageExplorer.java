...
package cc.frz.ecl.filterpackageexplorer;
...
public class FilterPackageExplorer extends PackageExplorerPart {
	...
	public void createPartControl(Composite parent) {
		...
		newParent.setBackground(Display.getDefault().getSystemColor(SWT.COLOR_WHITE));
	...
	public IViewSite getViewSite() {
		...
		if (stackTrace[1].getClassName().equals("org.eclipse.jdt.ui.actions.CustomFiltersActionGroup")) {
			return new HackViewSite("org.eclipse.jdt.ui.PackageExplorer", super.getViewSite());
		}
	...
	public PackageExplorerContentProvider createContentProvider() {
		PackageExplorerContentProvider contentProvider = super.createContentProvider();
